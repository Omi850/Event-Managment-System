...
<body>
    ...
    <a href="/MyEventpending">
        <button>
            <i class="fas fa-calendar-alt"></i> Pending
            <span class="badge"><%= session.getAttribute("pending") %></span>
        </button>
    </a>
    <a href="/MyEventBooked">
        <button>
            <i class="fas fa-check-circle"></i> Booked
            <span class="badge"><%= session.getAttribute("accepted") %></span>
        </button>
    </a>
    <a href="/MyEventRejected">
        <button>
            <i class="fas fa-list"></i> Rejected
            <span class="badge"><%= session.getAttribute("rejected") %></span>
        </button>
    </a>
    <a href="/MyEventattend">
        <button>
    ...
    <a href="/MyEvent">
        <button>
            <i class="fas fa-calendar-day"></i> All Events
            <span class="badge"><%= session.getAttribute("BookCount") %></span>
        </button>
    </a>
</div>
    ...
    <tbody>
        ...
        <c:forEach var="std" items="${event}">
            <tr>
                ...
                <td>
                    <c:choose>
                        <c:when test="${std.statues == 'pending'}">
