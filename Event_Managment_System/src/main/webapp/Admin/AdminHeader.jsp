...
<body>
       <header class="header">
        <nav class="navbar">
            <div class="logo">
                <img src="/image/PngItem_2261747.png" alt="Logo" />
                <a href="#">Admin</a>
            </div>
            ...
            <ul class="links">
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="/AdminEventAdd"><i class="fas fa-plus"></i> Add Events</a>
                       <a href="/ShowEvent"><i class="fas fa-calendar-alt"></i> Upcoming</a>
                        <a href="/ShowEventcomAll"><i class="fas fa-list"></i> Event List</a>
                    </div>
                </li>
                <li><a href="/ShowUsersAll"><i class="fas fa-users"></i> Users</a></li>
                <li class="dropdown">
